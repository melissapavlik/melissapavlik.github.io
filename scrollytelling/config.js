...
//chapter13:africa-2//
		...
		{
			id: 'africa-2',
			title: '<span style="font-size:100px; line-height:100px; color:#FF7F0E; text-align:right; font-style:bold;">Africa</span><span style="font-size:40px;line-height:60px;color:white;text-align:right;font-style:italic;background-color:black;"></br>Conflict with the potential to crumble states and wreak regional havoc.</span>',
			image: '',
...
//chapter14:sahel-1//
		...
		{
			id: 'sahel-1',
			title: '<span style="font-size:100px; line-height:100px; color:white; font-style:bold;">The Sahel:</span><span style="font-size:75px; line-height:100px; color:white; font-style:italic;"> Mali, Burkina Faso, Niger, Mauritania and Chad </span><span style="background-color:#ffbb7a; color:black; line-height:50px; text-align:center;">High risk of conflicts diffusing and infecting neighbors </span>',
			image: '',
			description:'' ,
			location: {
