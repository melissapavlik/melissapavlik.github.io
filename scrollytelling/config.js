...
//us-intro//
		...
		{
			id: 'us-intro',
			title: '<span style="font-size:100px; line-height:100px; color:white;text-align:center;font-style:bold;background-color:black;"> United States </span><span style="background-color:#0D657D;color:black;line-height:50px;text-align:center;">Developed, democratic political system at risk of turning violent</span>',
			image: '',
			description: '',
			location: {
				center: [-101.55207, 38.27297],
...
//mexico-intro//
		...
		{
			id: 'mexico-intro',
			title: '<span style="font-size:100px; line-height:100px; color:white; text-align:center; font-style:bold; background-color:black;"> Mexico </span><span style="background-color:#5F9ED1; color:black; line-height:50px; text-align:center;"></br>High risk of cartel criminal market developing into an insurgency</span>',
			image: '',
			description: '',
			location: {
				center: [-108.64804, 21.96790],
...
//mexico-text//
		...
		{
			id: 'mexico-text',
			title: '<span style="font-size:50px; line-height:60px; color:white; text-align:center; font-style:bold; font-style:italic; color:#5F9ED1;"> As cartels in Mexico fragment and increase their power, violence spreads.</span>',
			image: '',
...
//ethiopia-intro//
		...
		{
			id: 'ethiopia-intro',
			title: '<span style="font-size:100px; line-height:100px; color:white; font-style:bold;">Ethiopia</span><span style="background-color:#A2C8EC; color:black; line-height:50px;"></br>At risk of increased fragmentation despite a popular and promising leader</span>',
			image: '',
			description: '',
			location: {
				center: [46.75444, 9.06499],
...
//somalia-intro//
		...
		{
			id: 'somalia-intro',
			title: '<span style="font-size:100px; line-height:100px; color:#FF7F0E; font-style:bold;">Somalia</span><span style="background-color:black; color:white; line-height:50px;"></br>High risk of Al Shabaab adapting to dominate and isolate a weak government</span>',
			image: '',
			description: '',
			location: {
				center: [44.02895, 5.29517],
...
//middle-east-intro//

		{
			...
			title: '<span style="font-size:100px; line-height:100px; color:#DBEFF4; text-align:right; font-style:bold; -webkit-text-stroke-width:1px; -webkit-text-stroke-color:black;">The Middle East</span><span style="font-size:40px; line-height:60px; color:white; text-align:right; font-style:italic; background-color:black;"></br>etcetcetcetcetcetc</span>',
			image: '',
			description: '',
			location: {
				center: [47.23947, 26.89468],
...
//iran-intro//
		...
		{
			id: 'iran-intro',
			title: '<span style="font-size:100px; line-height:100px; color:black; font-style:bold;">Iran</span><span style="background-color:#FFBB7A; color:black; line-height:50px;"></br>High risk of center deteriorating amid regime escalation abroad and at home</span>',
			image: '',
			description: '',
			location: {
				center: [49.94506, 32.57550],
...
//central-asia-intro//

		{
			...
			title: '<span style="font-size:100px; line-height:100px; color:#F88D2F; text-align:right; font-style:bold; -webkit-text-stroke-width:1px; -webkit-text-stroke-color:black;">Central Asia</span><span style="font-size:40px; line-height:60px; color:white; text-align:right; font-style:italic; background-color:black;"></br>etcetcetcetcetcetc</span>',
			image: '',
			description: '',
			location: {
				center: [68.02622, 43.61508],
...
//south-asia-intro//
		...
		{
			id: 'south-asia-intro',
			title: '<span style="font-size:100px; line-height:100px; color:#FACFA7; text-align:right; font-style:bold; -webkit-text-stroke-width:1px; -webkit-text-stroke-color:black;">South Asia</span><span style="font-size:40px; line-height:60px; color:white; text-align:right; font-style:italic; background-color:black;"></br>etcetcetcetcetcetc</span>',
			image: '',
			description: '',
			location: {
				center: [77.51391, 22.37724],
...
//india-intro//
		...
		{
			id: 'india-intro',
			title: '<span style="font-size:100px; line-height:100px; color:white; font-style:bold;">India</span><span style="background-color:#898989; color:black; line-height:50px;"></br>High risk of recent policies derailing with uncontrollable effects</span>',
			image: '',
			description: '',
			location: {
				center: [68.67099, 22.51075],
